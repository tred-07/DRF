...
from .views import movie_list,movie_detail,StreamListAV,StreamDetailAV,CreateReview,ReviewList,ReviewDetail,UserReviewDetail
# from django import 
urlpatterns=[
    ...
    path('review/',ReviewList.as_view(),name='review-list'), # review list for all movies
